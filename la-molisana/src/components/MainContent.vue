  ...
  <main id="site_main">
    <section class="container">
      ...
      <div class="products row">
        <PastaElement class="col-3" v-for="pasta in pastas" :key="pasta.title" :image="pasta.src" :titolo="pasta.titolo" />
      </div>
    </section>
    <!-- /.container -->
  </main>
...
<script>
import PastaElement from "./PastaElement.vue"
export default {
  data() {
    return {
      pastas: [
...
#site_main {
  padding: 2rem;
  background-image: url("../assets/fondo-pag-speciali.jpg");
  h1 {
    text-align: center;
    font-size: 50px;
  }
